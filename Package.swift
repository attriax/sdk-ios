...
let package = Package(
    ...
    dependencies: [],
    targets: [
        // The KMP core, vendored as a binary XCFramework for LOCAL DEV. Release tags
        // pin the GitHub-Release url+checksum stanza instead (swapped on the release
        // commit; see scripts/release-apple.sh) — consumers resolve tags, not main.
        .binaryTarget(
            name: "AttriaxCore",
